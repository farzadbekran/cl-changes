...
(asdf:defsystem #:cl-changes
  :serial t
  :description "detects changes of the slot values and sets its changedp slot to t
...
the format for the slot's on change function is (lambda (object))"
  ...
  :author "farzadbekran <farzadbekran@gmail.com>"
  :license "Free, do whatever you want"
